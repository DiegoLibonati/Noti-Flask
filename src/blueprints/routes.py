...
from src.constants.vars import BLUEPRINT_AUTH_PATH, BLUEPRINT_HEALTH_PATH, BLUEPRINT_NOTES_PATH


def register_routes(app: Flask) -> None:
    app.register_blueprint(health_bp, url_prefix=BLUEPRINT_HEALTH_PATH)
